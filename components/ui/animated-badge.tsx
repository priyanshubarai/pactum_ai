...
const AnimatedBadge = ({
  ...
  const content = (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative flex max-w-fit items-center justify-center gap-3 rounded-full border border-[#282828] bg-[#111111] px-4 py-1.5  transition-colors dark:border-neutral-700/80 dark:bg-black text-white p-2"
    >
